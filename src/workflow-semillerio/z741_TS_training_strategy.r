...
PARAM$train$undersampling  <- 0.5   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

PARAM$train$semilla  <- 101111  # cambiar por su propia semilla  !!!
