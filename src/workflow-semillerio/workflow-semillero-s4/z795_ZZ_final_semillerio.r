...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_S4"
PARAM$exp_input  <- "HT7510_S4"
...
PARAM$semillerio  <- 25   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 101111  # se utiliza para generar el vector de  PARAM$semillerio  semillas
